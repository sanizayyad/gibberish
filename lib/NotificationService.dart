...
class NotificationPlugin {
  ...
  NotificationPlugin() {
    //initializing the plugin with settings
    init();
  }
...
//      timeoutAfter: 5000,
  ...
  Future<void> showNotificationWithAttachment() async {
    var attachmentPicturePath = await _downloadAndSaveFile(
        'https://etu.ru/assets/cache/images/international/students/800x1100-dsc_0076.023.jpg', 'attachment_img.jpg');
